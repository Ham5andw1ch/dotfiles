...
static const char *fonts[]          = { "Source Code Pro:size=9:width=1", "SauceCodePro Nerd Font:size=9:width=1" };
static const char dmenufont[]       = "Source Code Pro:size=9:width=1";
...
static const char urgbordercolor[]  = "#7a828d"; // pending
static const char urgbgcolor[]      = "#1c2023";
static const char urgfgcolor[]      = "#c7ae95";
static const char blue[]            = "#95aec7";
...
static const char *colors[][4]      = {
	...
	/* Custom colors */
	[SchemeRandom] =  { blue,    urgbgcolor,    urgbordercolor },
};
